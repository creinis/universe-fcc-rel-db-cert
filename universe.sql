...
--
ALTER TABLE ONLY public.planet ADD CONSTRAINT planet_data_key UNIQUE (data);
...
--
ALTER TABLE ONLY public.planet ADD CONSTRAINT planet_star_id_key UNIQUE (star_id);

--
-- Name: solar_system solar_system_data_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
ALTER TABLE ONLY public.solar_system ADD CONSTRAINT solar_system_data_key UNIQUE (data);
...
--
ALTER TABLE ONLY public.star ADD CONSTRAINT star_data_key UNIQUE (data);
